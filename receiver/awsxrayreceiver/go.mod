...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/xray v1.39.6
	github.com/google/go-cmp v0.7.0
	github.com/google/uuid v1.6.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/proxy v0.139.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/xray v0.139.0
