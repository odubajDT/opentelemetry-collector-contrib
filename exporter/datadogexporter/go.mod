...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/hostname/hostnameinterface v0.64.3
	github.com/DataDog/datadog-agent/comp/core/log v0.56.2
	github.com/DataDog/datadog-agent/comp/logs/agent/config v0.64.3
	github.com/DataDog/datadog-agent/comp/otelcol/logsagentpipeline v0.64.3
	github.com/DataDog/datadog-agent/comp/otelcol/logsagentpipeline/logsagentpipelineimpl v0.64.3
	...
	github.com/DataDog/datadog-agent/pkg/logs/sources v0.64.3
