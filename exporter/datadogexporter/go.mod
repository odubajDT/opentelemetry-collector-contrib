...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/hostname/hostnameinterface v0.66.0
	github.com/DataDog/datadog-agent/comp/core/log v0.56.2
	github.com/DataDog/datadog-agent/comp/logs/agent/config v0.66.0
	github.com/DataDog/datadog-agent/comp/otelcol/logsagentpipeline v0.66.0
	github.com/DataDog/datadog-agent/comp/otelcol/logsagentpipeline/logsagentpipelineimpl v0.66.0
	...
	github.com/DataDog/datadog-agent/pkg/logs/sources v0.66.0
